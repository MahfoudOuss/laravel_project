<x-layout>
    ...
    <div class="mx-4">
        ...
        @auth
        <x-card class="mt-5 p-2 flex space-x-6 flex justify-around items-center">
            ...
            <form method="POST" action="/listings/{{$listing->id}}">
                @csrf
                @method('DELETE')
                <button class=" text-red-500 rounded py-2 px-4 hover:bg-red">
